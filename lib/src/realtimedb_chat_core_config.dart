...
/// for rooms and users collections. Call [RealtimeDBChatCoreConfig.instance.setConfig]
/// before doing anything else with [RealtimeDBChatCoreConfig.instance] if you want to
/// change the default collection names. When using custom names don't forget
/// to update your security rules and indexes.
@immutable
class RealtimeDBChatCoreConfig {
  const RealtimeDBChatCoreConfig(
  ...
  /// Property to set messages collection name.
