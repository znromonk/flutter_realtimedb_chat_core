...
import 'package:flutter_realtimedb_chat_core/flutter_realtimedb_chat_core.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _register() async {
    ...
    try {
      ...
      await FirebaseChatCore.instance.createUserInRealtimeDB(
        types.User(
          firstName: _firstName,
          id: credential.user!.uid,
          imageUrl:
              'https://via.placeholder.com/150?text=${_firstName ?? 'J'.substring(0, 1)}${_lastName ?? 'D'.substring(0, 1)}',
          lastName: _lastName,
        ),
      );
